...
from analysis._types import DeriveRangesCommand


def main(command: DeriveRangesCommand, spark=None) -> None:
    ...
    spark.read.parquet(f"{warehouse_root}/indexOpsAgg").createOrReplaceTempView("op_count_item")
    ...
    df1.write \
        ...
        .mode("overwrite") \
        .parquet(f"{warehouse_root}/partitionRanges/")
